...
def p_me(z, win):
    ...
    '''
    try:
       # glcm = greycomatrix(z2, [5], [0], 256, symmetric=True, normed=True)
        glcm = greycomatrix(z, [1], [0], symmetric=True, normed=True)
       # return (glcm)
...
##        img_paths = [r'D:\Users\gianm\Documents\Ricerca post-laurea\CCI+\amazonia\unlabeled_data\20KNA/']*2+[r'D:\Users\gianm\Documents\Ricerca post-laurea\CCI+\amazonia\unlabeled_data\20KPF/']*2#+['6.svm-opt-train-glcm-final_test-data/']*2
        img_paths = ['6.svm-opt-train-glcm-final_test-data/train_sav/']*2
        output_names = [
            ...
            ######################################################################
                ...
                try:
                    ...
                    print("Loaded model from disk")        
                        ...
                        sub_sampled = np.random.permutation(n_train)[:n_train//10]
                        xTrain = xTrain[sub_sampled]
                        labels = labels[sub_sampled]
